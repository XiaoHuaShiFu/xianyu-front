      ...
      <div id="u0" class="ax_default" data-label="内容框架">
        <div id="u0_state0" class="panel_state" data-label="State1" style="">
          <div id="u0_state0_content" class="panel_state_content">
            ...
            <!-- Unnamed (组合) -->
            <div id="u1" class="ax_default" data-left="48" data-top="278" data-width="280" data-height="50">
            ...
            <!-- Unnamed (组合) -->
            <div id="u3" class="ax_default" data-left="99" data-top="279" data-width="229" data-height="48">

              <!-- 密码 (文本框) -->
              <div id="u4" class="ax_default _默认样式" data-label="密码">
                <div id="u4_div" class=""></div>
                <input id="u4_input" type="password" value="" class="u4_input" maxlength="20"/>
              </div>
            </div>

            <!-- Unnamed (矩形) -->
            <div id="u5" class="ax_default _默认样式">
            ...
            <!-- Unnamed (组合) -->
            <div id="u6" class="ax_default" data-left="48" data-top="180" data-width="280" data-height="50">
            ...
            <!-- Unnamed (组合) -->
            <div id="u10" class="ax_default" data-left="48" data-top="229" data-width="280" data-height="50">
            ...
            <!-- Unnamed (组合) -->
            <div id="u12" class="ax_default" data-left="99" data-top="181" data-width="229" data-height="48">

              <!-- 手机号码 (文本框) -->
              <div id="u13" class="ax_default _默认样式" data-label="手机号码">
                <div id="u13_div" class=""></div>
                <input id="u13_input" type="text" value="" class="u13_input" maxlength="11"/>
              </div>
            </div>

            <!-- Unnamed (组合) -->
            <div id="u14" class="ax_default" data-left="99" data-top="230" data-width="229" data-height="48">

              <!-- 验证码 (文本框) -->
              <div id="u15" class="ax_default _默认样式" data-label="验证码">
                <div id="u15_div" class=""></div>
                <input id="u15_input" type="text" value="" class="u15_input" maxlength="6"/>
              </div>
            </div>
